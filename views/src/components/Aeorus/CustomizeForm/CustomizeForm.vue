<template>
	<div
		...
		<div class="aeorusUI_form_btns">
			<div
				class="aeorusUI_form_btn_cancel aeorusUI_form_btn themeFontColorMain ac"
...
<script src="./CustomizeForm.js"></script>

<style scoped lang="less" src="./CustomizeForm.less"></style>