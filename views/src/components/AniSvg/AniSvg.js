...
export default {
	...
	mounted() {
		this.component_aniSvg_loadAniSvgTxt(() => {
			...
			utils.checkAnimationEnd(this.$refs.component_aniSvg_ref, 'animationend', this.component_aniSvg_animationend);
			utils.checkAnimationEnd(this.$refs.component_aniSvg_ref, 'webkitAnimationEnd', this.component_aniSvg_animationend);
		});
	},
	methods: {
		...mapActions([
